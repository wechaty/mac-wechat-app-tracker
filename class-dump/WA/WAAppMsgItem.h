...
@class NSDictionary, NSString, WAAppPackageInfo, WADynamicPageInfo, WANativeAppMsgInfo, WAUpdatableMsgInfo;
...
@interface WAAppMsgItem : NSObject
{
    ...
    NSDictionary *_shareProductInfoDic;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSDictionary *shareProductInfoDic; // @synthesize shareProductInfoDic=_shareProductInfoDic;
...
- (id)getGroupProductInfoDic;
- (BOOL)isGroupItemShareFromHaoYouYouXuan;
- (BOOL)isWAGroupProductItem;
- (id)toXML;
