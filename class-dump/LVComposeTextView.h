...
@protocol LVComposeTextViewDelegate;

@interface LVComposeTextView : MMComposeTextView
{
    id <LVComposeTextViewDelegate> _textContrainerDelegate;
...
@property(nonatomic) __weak id <LVComposeTextViewDelegate> textContrainerDelegate; // @synthesize textContrainerDelegate=_textContrainerDelegate;
- (void)didChangeText;
- (void)sendMessage;
