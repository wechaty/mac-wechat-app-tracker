...
- (int)transcode:(id)arg1 dstMP4:(id)arg2 inPara:(struct WxVideoTransPara *)arg3 notifyProcessBegin:(CDUnknownBlockType)arg4;
- (int)transcode:(id)arg1 dstMP4:(id)arg2 inPara:(struct WxVideoTransPara *)arg3;
