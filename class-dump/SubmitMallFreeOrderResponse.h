...
@interface SubmitMallFreeOrderResponse : PBGeneratedMessage
{
    unsigned int hasBaseResponse:1;
    unsigned int hasPrepareId:1;
...
@property(retain, nonatomic, setter=SetPrepareId:) NSString *prepareId; // @synthesize prepareId;
@property(readonly, nonatomic) BOOL hasPrepareId; // @synthesize hasPrepareId;
