...
@interface ModLiveMicModeRequest : PBGeneratedMessage
{
    unsigned int hasBaseRequest:1;
    unsigned int hasLiveId:1;
    unsigned int hasRoomId:1;
    unsigned int hasLiveMicMode:1;
    unsigned int liveMicMode;
...
- (void).cxx_destruct;
@property(nonatomic, setter=SetLiveMicMode:) unsigned int liveMicMode; // @synthesize liveMicMode;
@property(readonly, nonatomic) BOOL hasLiveMicMode; // @synthesize hasLiveMicMode;
