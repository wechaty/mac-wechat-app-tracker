...
- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableArray *mutableImgPairListList; // @synthesize mutableImgPairListList;
...
- (void)addImgPairList:(id)arg1;
- (void)addImgPairListFromArray:(id)arg1;
