...
@interface ClientPerfReportReq : PBGeneratedMessage
{
    ...
    unsigned int hasEventIdCnt:1;
    unsigned int eventIdCnt;
...
@property(nonatomic, setter=SetEventIdCnt:) unsigned int eventIdCnt; // @synthesize eventIdCnt;
@property(readonly, nonatomic) BOOL hasEventIdCnt; // @synthesize hasEventIdCnt;
