...
- (BOOL)asynchronouslyWaitUntilCompleted:(id *)arg1 timeout:(double)arg2;
- (id)asynchronousFirstOrDefault:(id)arg1 success:(char *)arg2 error:(id *)arg3 timeout:(double)arg4;
