...
- (void).cxx_destruct;
@property(retain, nonatomic, setter=SetCmdValue:) NSString *cmdValue; // @synthesize cmdValue;
@property(readonly, nonatomic) BOOL hasCmdValue; // @synthesize hasCmdValue;
