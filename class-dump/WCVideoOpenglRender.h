...
@class MMTimer, NSView, OpenglRenderView, VoipOpenglesContext;
...
- (void).cxx_destruct;
@property(nonatomic) BOOL m_frontCamera; // @synthesize m_frontCamera=_m_frontCamera;
...
@property(retain, nonatomic) NSView *m_renderView; // @synthesize m_renderView;
