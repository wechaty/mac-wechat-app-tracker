...
@interface SearchOpenIMContactResp : PBGeneratedMessage
{
    unsigned int hasBaseResponse:1;
    unsigned int hasContact:1;
    unsigned int hasUrl:1;
    BaseResponse *baseResponse;
    SearchOpenIMContactItem *contact;
    NSString *url;
}
...
@property(retain, nonatomic, setter=SetContact:) SearchOpenIMContactItem *contact; // @synthesize contact;
