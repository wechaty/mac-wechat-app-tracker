...
@property(retain, nonatomic, setter=SetKfworkerId:) NSString *kfworkerId; // @synthesize kfworkerId;
@property(readonly, nonatomic) BOOL hasKfworkerId; // @synthesize hasKfworkerId;
