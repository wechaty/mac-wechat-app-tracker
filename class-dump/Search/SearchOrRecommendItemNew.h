...
@interface SearchOrRecommendItemNew : PBGeneratedMessage
{
...
@property(retain, nonatomic, setter=SetCustomizedInfo:) CustomizedInfoNew *customizedInfo; // @synthesize customizedInfo;
