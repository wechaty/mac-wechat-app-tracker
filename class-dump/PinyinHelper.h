...
+ (id)getAllHanyuPinyinStringWithChar:(unsigned short)arg1 withHanyuPinyinOutputFormat:(id)arg2;
...
+ (void)getAllHanyuPinyinStringWithChar:(unsigned short)arg1 withHanyuPinyinOutputFormat:(id)arg2 outputBlock:(CDUnknownBlockType)arg3;
