...
@interface GetProductDiscountResponse : PBGeneratedMessage
{
    unsigned int hasBaseResponse:1;
    unsigned int hasDiscountDetail:1;
...
@property(retain, nonatomic, setter=SetDiscountDetail:) NSString *discountDetail; // @synthesize discountDetail;
@property(readonly, nonatomic) BOOL hasDiscountDetail; // @synthesize hasDiscountDetail;
