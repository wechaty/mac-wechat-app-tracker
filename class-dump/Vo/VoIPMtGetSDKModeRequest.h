...
@interface VoIPMtGetSDKModeRequest : PBGeneratedMessage
{
...
- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableArray *mutableUserListList; // @synthesize mutableUserListList;
...
- (void)addUserListFromArray:(id)arg1;
