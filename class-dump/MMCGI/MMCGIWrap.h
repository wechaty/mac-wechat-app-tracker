...
@class NSData, NSString, PBGeneratedMessage, UrlInfo;
...
@property(nonatomic) int m_netwrokStrategy; // @synthesize m_netwrokStrategy=_m_netwrokStrategy;
