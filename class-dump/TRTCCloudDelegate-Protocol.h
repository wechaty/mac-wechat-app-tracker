...
- (void)onSystemAudioLoopbackError:(int)arg1;
...
- (void)onDevice:(NSString *)arg1 type:(long long)arg2 stateChanged:(long long)arg3;
...
- (void)onUserSubStreamAvailable:(NSString *)arg1 available:(BOOL)arg2;
- (void)onUserVideoAvailable:(NSString *)arg1 available:(BOOL)arg2;
