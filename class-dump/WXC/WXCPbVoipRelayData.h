...
@interface WXCPbVoipRelayData : PBGeneratedMessage
{
    unsigned int hasType:1;
    unsigned int hasBuffer:1;
    int type;
    WXCPbSKBuiltinBuffer_t *buffer;
}

+ (id)parseFromData:(id)arg1;
- (void).cxx_destruct;
@property(retain, nonatomic, setter=SetBuffer:) WXCPbSKBuiltinBuffer_t *buffer; // @synthesize buffer;
