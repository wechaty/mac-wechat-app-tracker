...
@interface ConfMemberList : PBGeneratedMessage
{
    unsigned int hasImroomid:1;
    unsigned int hasRoomid:1;
    unsigned int hasMemberChangeSeq:1;
    unsigned int hasMemberChangeFrom:1;
    unsigned int memberChangeSeq;
    unsigned int memberChangeFrom;
...
- (void).cxx_destruct;
@property(nonatomic, setter=SetMemberChangeFrom:) unsigned int memberChangeFrom; // @synthesize memberChangeFrom;
@property(readonly, nonatomic) BOOL hasMemberChangeFrom; // @synthesize hasMemberChangeFrom;
@property(nonatomic, setter=SetMemberChangeSeq:) unsigned int memberChangeSeq; // @synthesize memberChangeSeq;
@property(readonly, nonatomic) BOOL hasMemberChangeSeq; // @synthesize hasMemberChangeSeq;
