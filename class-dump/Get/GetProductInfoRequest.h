...
- (void).cxx_destruct;
@property(retain, nonatomic, setter=SetQrUrl:) NSString *qrUrl; // @synthesize qrUrl;
@property(readonly, nonatomic) BOOL hasQrUrl; // @synthesize hasQrUrl;
