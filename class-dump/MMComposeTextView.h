...
#import "MMMentionViewControllerDelegate-Protocol.h"
...
- (void)setupWithChatContact:(id)arg1;
...
- (void)menuActionImageEdit:(id)arg1;
...
- (struct _NSRange)insertMentionWithContact:(id)arg1;
- (void)insertMentionWithContactWithoutRange:(id)arg1;
- (void)_innerInserImageContentWithLineFeed:(unsigned char)arg1;
- (void)insertImageWithRefresh:(id)arg1;
- (void)insertImageDataWithRefresh:(id)arg1 withLineFeed:(unsigned char)arg2;
- (void)insertRichAttachment:(id)arg1;
- (void)insertImageWith:(id)arg1;
...
@property(nonatomic) __weak id <MMComposeRichAttachmentTextViewDelegate> richAttachmentDelegate; // @dynamic richAttachmentDelegate;
