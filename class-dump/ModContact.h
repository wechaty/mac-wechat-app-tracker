...
@interface ModContact : PBGeneratedMessage
{
    ...
    unsigned int hasDeleteContactScene:1;
...
@property(retain, nonatomic, setter=SetSourceExtInfo:) NSString *sourceExtInfo; // @synthesize sourceExtInfo;
@property(readonly, nonatomic) BOOL hasSourceExtInfo; // @synthesize hasSourceExtInfo;
...
@property(nonatomic, setter=SetDeleteContactScene:) unsigned int deleteContactScene; // @synthesize deleteContactScene;
@property(readonly, nonatomic) BOOL hasDeleteContactScene; // @synthesize hasDeleteContactScene;
