...
@property(nonatomic, setter=SetLoginType:) unsigned int loginType; // @synthesize loginType;
@property(readonly, nonatomic) BOOL hasLoginType; // @synthesize hasLoginType;
