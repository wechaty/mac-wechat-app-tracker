...
@interface TXCHWVideoEncoder : TXIVideoEncoder
{
    ...
    CDUnknownBlockType _encodeLogger;
}

- (void).cxx_destruct;
@property(readonly, copy, nonatomic) CDUnknownBlockType encodeLogger; // @synthesize encodeLogger=_encodeLogger;
@property(retain) NSObject<OS_dispatch_source> *encodeTimer; // @synthesize encodeTimer=_encodeTimer;
...
- (int)releaseEncoder;
- (int)createEncoder:(struct TXSVideoEncoderParam *)arg1 IsRealTime:(BOOL)arg2;
- (struct __CFString *)h26xProfileLevelFromEncoderProfile:(int)arg1;
