...
@interface GetVoiceprintTicketRsaResponse : PBGeneratedMessage
{
    unsigned int hasBaseResponse:1;
    unsigned int hasVoiceprintTicket:1;
...
@property(retain, nonatomic, setter=SetVoiceprintTicket:) NSString *voiceprintTicket; // @synthesize voiceprintTicket;
@property(readonly, nonatomic) BOOL hasVoiceprintTicket; // @synthesize hasVoiceprintTicket;
