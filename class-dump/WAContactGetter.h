...
+ (void)getWeAppContactWithAppid:(id)arg1 force:(BOOL)arg2 handler:(CDUnknownBlockType)arg3;
...
+ (void)getWeAppContact:(id)arg1 force:(BOOL)arg2 handler:(CDUnknownBlockType)arg3;
