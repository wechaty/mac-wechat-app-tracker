...
@property(nonatomic, setter=SetOnlyAudio:) int onlyAudio; // @synthesize onlyAudio;
@property(readonly, nonatomic) BOOL hasOnlyAudio; // @synthesize hasOnlyAudio;
...
@property(nonatomic, setter=SetAnswer:) int answer; // @synthesize answer;
@property(readonly, nonatomic) BOOL hasAnswer; // @synthesize hasAnswer;
