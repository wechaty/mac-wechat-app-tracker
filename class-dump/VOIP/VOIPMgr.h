...
@interface VOIPMgr : MMService <IVOIPSyncExt, VOIPVideoHWEncDelegate, AVVideoDataSource, AUAudioDataSource, IAUAudioDeviceExt, MMService, AVVideoDeviceSessionDelegate>
{
    ...
    int mHWHeight;
    BOOL mCanCap720p;
    int mVOIPVideoHWEncMASK;
    int mHWEncCodecType;
    int mVOIPVideoHWDecMASK;
    int mHWDecCodecType;
    BOOL mIsOppoOldVer;
    VOIPVideoHWEnc *mVOIPVideoHWEnc;
    ...
    char *mCameraBuf;
    char *mCaptClipBuf;
    unsigned long long mCaptClipBufSize;
    unsigned long long mCameraBufSize;
    char *mDecRGBBuf;
    unsigned long long mDecRGBBufSize;
...
- (BOOL)GetAndSendFrame:(struct opaqueCMSampleBuffer *)arg1 isKeyFrame:(BOOL)arg2;
- (BOOL)GetAndSendParaSet:(struct opaqueCMSampleBuffer *)arg1;
...
- (void)StartTalk;
- (void)tryStartTalk;
- (void)getCMSampleBufferRef:(struct opaqueCMSampleBuffer *)arg1;
...
- (void)drawFrame:(char *)arg1 width:(unsigned long long)arg2 height:(unsigned long long)arg3;
