...
@interface MMMusicInfo : NSObject <PBCoding>
{
    ...
    BOOL _m_bHasLocalCover;
    int _m_originSourceType;
    NSString *_m_nsBizUserName;
    NSImage *_m_localCoverImage;
}
...
- (void).cxx_destruct;
@property(nonatomic) BOOL m_bHasLocalCover; // @synthesize m_bHasLocalCover=_m_bHasLocalCover;
@property(retain, nonatomic) NSImage *m_localCoverImage; // @synthesize m_localCoverImage=_m_localCoverImage;
