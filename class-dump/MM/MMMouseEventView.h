...
@interface MMMouseEventView : MMView
{
    CDUnknownBlockType _mouseUpEventBlock;
    CDUnknownBlockType _mouseDownEventBlock;
    CDUnknownBlockType _mouseScrollEventBlock;
}

- (void).cxx_destruct;
@property(copy, nonatomic) CDUnknownBlockType mouseScrollEventBlock; // @synthesize mouseScrollEventBlock=_mouseScrollEventBlock;
