...
@protocol MMImageEditTailorItemDelegate;

@interface MMImageEditTailorSelectItem : NSObject
{
    id <MMImageEditTailorItemDelegate> _delegate;
    NSView *_superView;
    double _borderWidth;
...
@property(nonatomic) __weak id <MMImageEditTailorItemDelegate> delegate; // @synthesize delegate=_delegate;
