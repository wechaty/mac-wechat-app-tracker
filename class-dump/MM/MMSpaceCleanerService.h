...
@interface MMSpaceCleanerService : MMService <IChatLogMigrateToMacExt, MMService>
{
    ...
    unsigned long long _m_diskSessionSize;
    ...
    unsigned long long _m_diskSpaceSize;
...
@property(nonatomic) unsigned long long m_diskSpaceSize; // @synthesize m_diskSpaceSize=_m_diskSpaceSize;
...
@property(nonatomic) unsigned long long m_diskSessionSize; // @synthesize m_diskSessionSize=_m_diskSessionSize;
...
- (id)computeSingleSessionTotalSizeInternal:(id)arg1 fileInodeNumberSet:(id)arg2;
...
- (id)getDiskSessionSizeString;
- (id)getTotalSessionSizeString;
- (id)getDiskSpaceSizeString;
