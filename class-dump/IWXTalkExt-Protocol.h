...
- (void)onRespPokerOrResumeFriend:(NSString *)arg1 isSuccess:(BOOL)arg2;
- (void)onRespActiveGroupInfoItemList:(NSArray *)arg1 isSuccess:(BOOL)arg2;
...
- (void)OnModifyGroupInfoResult:(BOOL)arg1 groupId:(NSString *)arg2;
...
- (void)OnInviteWXTalkModeResult:(BOOL)arg1 groupId:(NSString *)arg2;
