...
@interface SendDomainEmailResponse : PBGeneratedMessage
{
    unsigned int hasBaseResponse:1;
    unsigned int hasDomainEmailRet:1;
...
@property(nonatomic, setter=SetDomainEmailRet:) int domainEmailRet; // @synthesize domainEmailRet;
@property(readonly, nonatomic) BOOL hasDomainEmailRet; // @synthesize hasDomainEmailRet;
