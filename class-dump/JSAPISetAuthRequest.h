...
@interface JSAPISetAuthRequest : PBGeneratedMessage
{
    ...
    unsigned int hasSignatureFlag:1;
    unsigned int signatureFlag;
...
@property(nonatomic, setter=SetSignatureFlag:) unsigned int signatureFlag; // @synthesize signatureFlag;
@property(readonly, nonatomic) BOOL hasSignatureFlag; // @synthesize hasSignatureFlag;
