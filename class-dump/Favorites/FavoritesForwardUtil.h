...
+ (id)ConvertFeedLiveMsg2FavData:(id)arg1;
+ (id)ConvertFeedMsg2FavData:(id)arg1;
...
+ (id)ConvertMsg2FavData:(id)arg1 useToForward:(BOOL)arg2 isToWeWork:(BOOL)arg3;
+ (id)GetDefaultFavDataForSendFailedMsgWrap:(id)arg1;
...
+ (id)ConvertMsgList2MsgWrap:(id)arg1 useToForward:(BOOL)arg2 isToWeWork:(BOOL)arg3;
