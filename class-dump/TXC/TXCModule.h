...
@property(copy) NSString *mID; // @synthesize mID=_mID;
...
- (BOOL)setStatusValue:(id)arg1 forKey:(int)arg2 Key2:(unsigned short)arg3;
- (BOOL)setStatusValue:(id)arg1 forKey:(int)arg2;
- (id)getID;
- (void)clearID;
- (void)setID:(id)arg1;
- (void)dealloc;
