...
@property(nonatomic) BOOL anchorTopLeft; // @synthesize anchorTopLeft=_anchorTopLeft;
@property(nonatomic) double alpha; // @synthesize alpha=_alpha;
@property(nonatomic) BOOL ignoreAspectRatio; // @synthesize ignoreAspectRatio=_ignoreAspectRatio;
