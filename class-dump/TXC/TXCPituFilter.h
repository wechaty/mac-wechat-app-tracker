...
@property(nonatomic) BOOL beautyDisabled; // @synthesize beautyDisabled=_beautyDisabled;
@property(retain, nonatomic) TXCBeautyParams *params; // @synthesize params=_params;
@property(nonatomic) int outputAngle; // @synthesize outputAngle=_outputAngle;
