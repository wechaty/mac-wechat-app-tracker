...
@interface UploadVideoReportData : NSObject
{
    ...
    NSString *_m_newcdnip;
}

- (void).cxx_destruct;
@property(nonatomic) unsigned int m_uploadStatus; // @synthesize m_uploadStatus=_m_uploadStatus;
@property(retain, nonatomic) NSString *m_newcdnip; // @synthesize m_newcdnip=_m_newcdnip;
