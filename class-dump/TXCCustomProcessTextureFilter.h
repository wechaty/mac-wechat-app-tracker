...
@interface TXCCustomProcessTextureFilter : TXCFilter <TXCCustomProcessable>
{
...
@property(nonatomic) unsigned int outputTextureId; // @synthesize outputTextureId=_outputTextureId;
