...
@interface WXCPbCSAddVoiceGroupMemberReq : PBGeneratedMessage
{
    ...
    NSMutableArray *mutableWxUserNamesList;
}

+ (id)parseFromData:(id)arg1;
- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableArray *mutableWxUserNamesList; // @synthesize mutableWxUserNamesList;
...
- (void)addWxUserNamesFromArray:(id)arg1;
- (void)addWxUserNames:(id)arg1;
- (void)addMembersFromArray:(id)arg1;
- (void)addMembers:(unsigned int)arg1;
