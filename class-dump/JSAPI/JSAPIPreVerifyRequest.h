...
@interface JSAPIPreVerifyRequest : PBGeneratedMessage
{
    ...
    NSString *url;
    NSString *appid;
    NSMutableArray *mutableJsapiListList;
    NSString *timestamp;
    NSString *noncestr;
    NSString *signature;
...
@property(retain, nonatomic) NSMutableArray *mutableJsapiListList; // @synthesize mutableJsapiListList;
...
- (void)addJsapiListFromArray:(id)arg1;
