...
@interface TRTCConfig : NSObject
{
    ...
    long long _localProcessBufferType;
    struct CGSize _videoSize;
}

- (void).cxx_destruct;
@property(nonatomic) long long localProcessBufferType; // @synthesize localProcessBufferType=_localProcessBufferType;
...
@property(nonatomic) BOOL setByAPI; // @synthesize setByAPI=_setByAPI;
