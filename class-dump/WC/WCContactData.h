...
+ (const void *)m_uiChatRoomVersion;
+ (const void *)m_nsEncodeUserName;
+ (const void *)m_nsAliasName;
+ (const void *)m_nsGoogleContactName;
+ (const void *)m_nsBrandIconUrl;
+ (const void *)m_nsDraft;
+ (const void *)m_nsChatRoomDesc;
+ (const void *)m_uiChatRoomStatus;
+ (const void *)m_nsChatRoomAdminList;
+ (const void *)m_nsChatRoomMemList;
+ (const void *)m_nsHeadHDMd5;
+ (const void *)m_nsHeadHDImgUrl;
+ (const void *)m_nsHeadImgUrl;
+ (const void *)m_uiImgKey;
+ (const void *)m_nsImgStatus;
+ (const void *)m_uiType;
+ (const void *)m_uiSex;
+ (const void *)m_uiCertificationFlag;
+ (const void *)m_nsRemarkPYShort;
+ (const void *)m_nsRemarkPYFull;
+ (const void *)m_nsRemark;
+ (const void *)m_nsShortPY;
+ (const void *)m_nsFullPY;
+ (const void *)m_nsNickName;
+ (const void *)m_uiConType;
