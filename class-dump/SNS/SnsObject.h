...
@interface SnsObject : PBGeneratedMessage
{
    ...
    unsigned int hasObjectOperations:1;
...
@property(readonly, nonatomic) BOOL hasPreDownloadInfo; // @synthesize hasPreDownloadInfo;
...
@property(retain, nonatomic, setter=SetObjectOperations:) SKBuiltinBuffer_t *objectOperations; // @synthesize objectOperations;
@property(readonly, nonatomic) BOOL hasObjectOperations; // @synthesize hasObjectOperations;
