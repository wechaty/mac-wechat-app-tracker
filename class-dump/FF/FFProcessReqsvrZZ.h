...
@interface FFProcessReqsvrZZ : MMService <ImgMessageHandlerDelegate, VideoMessageHandlerDelegate, AppMessageHandlerDelegate, TextMessageHandlerDelegate, VoiceMessageHandlerDelegate, EmoticonMessageHandlerDelegate, RecordMessageHandlerDelegate, MMCDNDownloadMgrExt, IMessageExt, RoomHistoryMessageHandlerDelegate, IMessageServiceVideoExt, IMessageServiceImageExt, IMessageServiceFileExt, MMService>
{
    ...
    MMThreadSafeDictionary *_downloadingRawVideoMessageSet;
...
@property(retain, nonatomic) MMThreadSafeDictionary *downloadingRawVideoMessageSet; // @synthesize downloadingRawVideoMessageSet=_downloadingRawVideoMessageSet;
...
- (BOOL)containsMultiSelectMsg:(id)arg1;
...
- (id)forwardRawVideoMessage:(id)arg1 toUser:(id)arg2 sourceInfo:(id)arg3;
...
- (void)onFinishGenVideoThumbTask:(id)arg1;
- (void)onAddGenVideoThumbTask:(id)arg1 operation:(id)arg2;
- (void)onFinishCompressTask:(id)arg1;
- (void)onAddCompressTask:(id)arg1 operation:(id)arg2;
...
- (id)SendAppURLMessageFromUser:(id)arg1 toUsrName:(id)arg2 withTitle:(id)arg3 url:(id)arg4 description:(id)arg5 thumbnailData:(id)arg6 sourceUserName:(id)arg7 sourceDisplayName:(id)arg8 sourceInfo:(id)arg9;
...
- (void)updateRawVideoSizeIfNeed:(id)arg1;
...
- (void)cancelDownloadRawVideoWithMessage:(id)arg1;
- (BOOL)downloadVideoWithMessage:(id)arg1 priorityInfo:(id)arg2 downloadType:(unsigned long long)arg3;
- (BOOL)downloadRawVideoWithMessage:(id)arg1 priorityInfo:(id)arg2 downloadType:(unsigned long long)arg3;
- (BOOL)downloadVideoWithMessage:(id)arg1;
- (void)removeFromListsWhenVideoDownloadEnd:(id)arg1;
- (void)onVideoDownloadCancel:(id)arg1 downloadType:(unsigned long long)arg2;
- (void)onRawVideoDownloadCancel:(id)arg1 downloadType:(unsigned long long)arg2;
- (void)onVideoDownloadFailed:(id)arg1 downloadType:(unsigned long long)arg2;
- (void)onRawVideoDownloadFailed:(id)arg1 downloadType:(unsigned long long)arg2;
- (void)onVideoDownloadFinished:(id)arg1 downloadType:(unsigned long long)arg2;
- (void)onRawVideoDownloadFinished:(id)arg1 downloadType:(unsigned long long)arg2;
- (void)onVideoDownloading:(id)arg1 downloadType:(unsigned long long)arg2;
- (BOOL)isRawVideoMsgDownloading:(id)arg1;
- (BOOL)isVideoMsgDownloading:(id)arg1;
- (BOOL)isVideoMsgInWaitCompressTaskList:(id)arg1;
- (unsigned int)checkCurrentVideoMsgCompressStatus:(id)arg1;
...
- (id)forwardRawVideoMessageToWeWork:(id)arg1 isSpeperateForward:(BOOL)arg2;
