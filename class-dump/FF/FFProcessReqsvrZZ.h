...
- (BOOL)downloadVideoWithMessage:(id)arg1 priorityInfo:(id)arg2;
- (BOOL)downloadVideoWithMessage:(id)arg1;
- (void)onVideoDownloadCancel:(id)arg1;
- (void)onVideoDownloadFailed:(id)arg1 bFlag:(BOOL)arg2;
- (void)onVideoDownloadFinished:(id)arg1;
- (void)onVideoDownloading:(id)arg1;
...
- (void)_startDownloadFileWithMessage:(id)arg1 destinationPath:(id)arg2 signature:(id)arg3 fakeAeskey:(id)arg4 fakeSignature:(id)arg5 priorityInfo:(id)arg6;
- (void)downloadFileWithMessage:(id)arg1 chatName:(id)arg2 destinationPath:(id)arg3 priorityInfo:(id)arg4;
- (void)downloadFileWithMessage:(id)arg1 chatName:(id)arg2 destinationPath:(id)arg3;
- (void)onFileDownloadCancel:(id)arg1;
- (void)onFileDownloadFailed:(id)arg1;
- (void)onFileDownloadFinished:(id)arg1;
- (void)onFileDownloading:(id)arg1;
...
- (BOOL)downloadMidImageWithMessage:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (BOOL)downloadImageWithMessage:(id)arg1 completion:(CDUnknownBlockType)arg2 priorityInfo:(id)arg3;
- (BOOL)downloadImageWithMessage:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)onImageDownloadCancel:(id)arg1;
- (void)onImageDownloadFailed:(id)arg1;
- (void)onImageDownloadFinished:(id)arg1 fileMD5:(id)arg2;
...
- (void)handleMessageDownload:(id)arg1 msgData:(id)arg2;
