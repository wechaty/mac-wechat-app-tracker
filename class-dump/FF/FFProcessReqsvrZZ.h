...
- (unsigned char)FFProcessTReqWithStrZZ:(id)arg1 toUser:(id)arg2;
...
- (void)addMsgToDBAndNotify:(id)arg1 withSessionList:(id)arg2 andIsFirstSync:(BOOL)arg3;
- (void)notAddMsgToDBAndNotify:(id)arg1 withSessionList:(id)arg2 andIsFirstSync:(BOOL)arg3;
