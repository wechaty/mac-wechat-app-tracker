...
@property(nonatomic, setter=SetActionCnt:) unsigned int actionCnt; // @synthesize actionCnt;
@property(readonly, nonatomic) BOOL hasActionCnt; // @synthesize hasActionCnt;
