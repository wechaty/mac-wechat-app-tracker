...
@interface GroupCardRequest : PBGeneratedMessage
{
    unsigned int hasBaseRequest:1;
    unsigned int hasOpCode:1;
    unsigned int hasGroupNickName:1;
    unsigned int hasMemberCount:1;
    unsigned int hasGroupUserName:1;
    unsigned int opCode;
...
- (void).cxx_destruct;
@property(retain, nonatomic, setter=SetGroupUserName:) NSString *groupUserName; // @synthesize groupUserName;
@property(readonly, nonatomic) BOOL hasGroupUserName; // @synthesize hasGroupUserName;
...
@property(retain, nonatomic, setter=SetGroupNickName:) NSString *groupNickName; // @synthesize groupNickName;
@property(readonly, nonatomic) BOOL hasGroupNickName; // @synthesize hasGroupNickName;
