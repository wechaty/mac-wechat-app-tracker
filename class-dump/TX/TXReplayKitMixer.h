...
- (struct opaqueCMSampleBuffer *)newSampleByMix:(struct opaqueCMSampleBuffer *)arg1 withType:(unsigned long long)arg2;
- (struct opaqueCMSampleBuffer *)getSendSampleBuffer:(id)arg1;
- (void)pickBuffer:(id *)arg1 and:(id *)arg2;
- (void)appendSample:(struct opaqueCMSampleBuffer *)arg1 withType:(unsigned long long)arg2;
