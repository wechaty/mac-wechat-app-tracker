...
@interface VerifyChatRoomReq : PBGeneratedMessage
{
    ...
    unsigned int hasApplyUserName:1;
...
@property(retain, nonatomic, setter=SetApplyUserName:) NSString *applyUserName; // @synthesize applyUserName;
@property(readonly, nonatomic) BOOL hasApplyUserName; // @synthesize hasApplyUserName;
